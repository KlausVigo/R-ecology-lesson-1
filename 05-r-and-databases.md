...
```{.output}
#> src:  sqlite 3.40.0 [/home/runner/work/R-ecology-lesson/R-ecology-lesson/site/built/data_raw/portal_mammals.sqlite]
...
```{.output}
#> # Source:   SQL [10 x 9]
#> # Database: sqlite 3.40.0 [/home/runner/work/R-ecology-lesson/R-ecology-lesson/site/built/data_raw/portal_mammals.sqlite]
...
```{.output}
#> # A tibble: 1,995 × 10
#>    plot_id plot_type      recor…¹ month   day  year speci…² sex   hindf…³ weight
#>      <int> <chr>            <int> <int> <int> <int> <chr>   <chr>   <int>  <int>
#>  1       1 Spectab exclo…       6     7    16  1977 PF      M          14     NA
#>  2       1 Spectab exclo…       8     7    16  1977 DM      M          37     NA
#>  3       1 Spectab exclo…       9     7    16  1977 DM      F          34     NA
#>  4       1 Spectab exclo…      78     8    19  1977 PF      M          16      9
#>  5       1 Spectab exclo…      80     8    19  1977 DS      M          48     NA
#>  6       1 Spectab exclo…     218     9    13  1977 PF      M          13      4
#>  7       1 Spectab exclo…     222     9    13  1977 DS      M          52     NA
#>  8       1 Spectab exclo…     239     9    13  1977 DS      M          48     NA
#>  9       1 Spectab exclo…     263    10    16  1977 DM      M          37     40
#> 10       1 Spectab exclo…     270    10    16  1977 DM      F          36     38
#> # … with 1,985 more rows, and abbreviated variable names ¹​record_id,
...
```{.output}
#> src:  sqlite 3.40.0 [/home/runner/work/R-ecology-lesson/R-ecology-lesson/site/built/data/portal-database-output.sqlite]
#> tbls:
```
